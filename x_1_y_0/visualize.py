...
plt.text(-0.44, 3, "Start Position", family="sans-serif", fontsize=14, fontdict=font)
plt.arrow(0, 2.8, 0, -2.4, head_width=0.1, head_length=0.1, fc="grey", ec="grey")
...
plt.text(2, 1.4, "Obstacle",family="sans-serif", fontsize=16,fontdict=font)
...
#     x = true_pos_x[:i+1]
#     y = true_pos_y[:i+1]
#     plt.scatter(1, 0, s=500, marker="o", c='red')
#     line.set_data(x, y)
#     return line,
