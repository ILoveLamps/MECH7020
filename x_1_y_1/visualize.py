...
# plt.scatter(1, 1, s=5000, marker="o", c='red')

# plt.text(-0.44, 2.8, "Start Position", family="sans-serif", fontsize=14, fontdict=font)
# plt.arrow(0, 2.6, 0, -2.2, head_width=0.1, head_length=0.1, fc="grey", ec="grey")
...
# plt.text(2, 3, "Obstacle",family="sans-serif", fontsize=16,fontdict=font)
# plt.arrow(2.3, 2.9, -1, -1.2, head_width=0.1, head_length=0.1, fc="grey", ec="grey")
...
def animate(i):
    x = true_pos_x[:i+1]
    y = true_pos_y[:i+1]
    plt.scatter(1, 1, s=500, marker="o", c='red')
    line.set_data(x, y)
    return line,
