...
plt.annotate('Initial Rotation', xy=(44, 0.4),  xycoords='data',
            xytext=(0, 0), textcoords='offset points',
            bbox=dict(boxstyle="round4,pad=.6", fc="0.9"), fontsize='x-large')

plt.annotate('Obstacle Avoidance', xy=(130, 0.1),  xycoords='data',
            xytext=(0, 0), textcoords='offset points',
            bbox=dict(boxstyle="round4,pad=.5", fc="0.9"), fontsize='xx-large' )

plt.annotate('Superficial adjustments as \n robot is very close to target', xy=(296, -0.1),  xycoords='data',
            xytext=(0, 0), textcoords='offset points',
...
# fig = plt.figure()
# ax = plt.axes(xlim=(0, 425), ylim=(-0.5, 0.75))
# line, = ax.plot([], [], lw=3)
